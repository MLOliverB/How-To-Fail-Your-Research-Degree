...
class SidebarButton {
    ...
    constructor(scene, y, text, click) {
        this.button = scene.add.rectangle(scene.x*2-150, scene.y*y, 260, scene.height*0.09, colours.get("button")).setInteractive();
        ...
        this.buttonText = scene.add.text(scene.x*2-150, scene.y*y, text, fonts.get("h3")).setOrigin(0.5);
    }
}
...
class CenterButton {
     ...
     */
    constructor(scene, y, text, click) {
        this.button = scene.add.rectangle(scene.x, scene.y*y, 260, scene.height*0.09, colours.get("buttonEvent")).setInteractive();
