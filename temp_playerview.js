import { CardBox, AddCardBox, CardDiscardBox, ToolbarButton, nextHandler, loadTeam, unloadTeam, pickUpCard, createTeam } from "../activity_cards/GameBoard.js";
...
export default class playerView extends Phaser.Scene {
    ...
    create() {
		...
		this.playerText = this.add.text(this.x, this.y*0.15, '0', {color: "0x000000"}).setOrigin(0.5).setFontSize(32);
		...
		for (let i = 0; i < this.numberOfTeams; i++) {
			this.teams.push([this.currentCard, this.middlePosition, this.leftEdge, this.rightEdge, this.cards, this.addCardBoxes]);
		}
		...
		new ToolbarButton(this, 0.19, 0.18, "Next Player", nextHandler, undefined, undefined);
		
		
        
        // setting up the board scrolling > should be zooming instead...
